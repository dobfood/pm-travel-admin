...
const tourSchema = yup.object().shape({
  ...
  numberDay: yup.number().required("Vui lòng nhập trường này").moreThan(0,"Vui lòng không nhâp giá trị âm"),
  price: yup.number().required("Vui lòng nhập trường này").moreThan(0,"Vui lòng không nhâp giá trị âm"),
  content: yup.string().required("Vui lòng nhập trường này"),
  // images: yup.array().required("Vui lòng nhập trường này"),
  rating: yup.number().required("Vui lòng nhập trường này").integer("Vui lòng nhập số nguyên").moreThan(0,"Vui lòng nhập giá trị lớn hơn 0").lessThan(6,"Vui lòng nhập giá trị bé hơn hoặt bằng 5"),
  // thumbnail: yup.string().required("Vui lòng nhập trường này"),
  description: yup.string(),
  codeTour: yup.string().required("Vui lòng nhập trường này").max(5, "Vui lòng không nhập quá 5 ký tự"),
  maxNumber: yup.number().required("Vui lòng nhập trường này").moreThan(0,"Vui lòng không nhâp giá trị âm"),
});
...
const Update = () => {
  ...
  const getProvince = async () => {
    const response = await fetch(`http://localhost:5001/client/provinces`, {
      method: "GET",
    });
    const data = await response.json();
    setProvince(data)
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <TextField
                ...
                name="destination"
                select
                error={Boolean(touched.destination) && Boolean(errors.destination)}
